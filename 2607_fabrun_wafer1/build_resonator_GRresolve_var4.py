...
GRresolve_var4_params = {
    ...
    "cap_trace_um":       5.0,
    "cap_finger_num":    42,
    "cap_finger_gap_um":  5.0,
    "cap_arm_width_um":  20.0,
    "cap_arm_gap_um":    10.0,
    "gs_trace_width_um": 20.0,
    "gs_gap_width_um":   20.0,
}

def build_resonator(params=GRresolve_var4_params, return_all_objs=False, ind_ft_spec=None, idc_ft_spec=None, gs_ft_spec=None):
